const HomePage = {
  async render() {
    return `<section id="why-us" class="why-us">
    <div class="container">
                                    ...
                                    <div class="box-item">
                                        ...
                                        <div class="box-item">
                                            ...
                                            <div class="box-item">
                                                ...
                                                <section>
                                                    <h1 class="judul">Bekerja sama dengan
                                                        <span class="highlight">kami</span>
                                                    </h1>
                                                    <p class="paragraf">
                                                        <span class="highlight">YoungMinds</span>
                                                        menyediakan layanan edukasi dan konsultasi seputar masalah kesehatan mental
                                                        kamu.</p>
                                                    <div class="gambar">
                                                        <img src="partner/mbkm.png" alt="Gambar 1">
                                                            <img src="partner/dicoding.png" alt="Gambar 2">
                                                                <img src="partner/posyandu.png" alt="Gambar 3"></div>
                                                            </section>
